-- Crear turnos para usuarios del Turno B que no tienen turno activo
-- Fecha: 2026-02-17

-- Paso 1: Ver usuarios del Turno B SIN turno activo
SELECT 
    u.id,
    u.username,
    u.name,
...
-- Paso 2: CREAR turnos para usuarios del Turno B sin turno activo
...
-- RESULTADO ESPERADO:
-- Todos los usuarios del Turno B deberían tener:
